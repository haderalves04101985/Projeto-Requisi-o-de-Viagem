...
public class JanelaVeiculoController implements Initializable {
    ...
    private void salvar(ActionEvent event) {
        if(tfid.getText().isEmpty()){
            ...
            servico.save_veic(v);
            AlertaUtil.mensagemSucesso("Veículo salvo com sucesso!");
            listaVeiculos();
        }else{
            ...
            if(btn.get() == ButtonType.OK){
                ...
                AlertaUtil.mensagemSucesso("Veículo alterado com sucesso!"); 
                listaVeiculos(); 
            }
        }
            tfid.setText("");
    ...
    private void editar(ActionEvent event) {
        ...
        if (selecionado != null) { 
            ...
            AlertaUtil.mensagemErro("Selecione um veículo!");
            }
    }
    ...
    private void excluir(ActionEvent event) {
        ...
        if(selecionado != null){
            ...
            if(btn.get() == ButtonType.OK){
                ...
                AlertaUtil.mensagemSucesso("Veículo excluído com sucesso");
                listaVeiculos();
            }
        }else{
            AlertaUtil.mensagemErro("Selecione um veículo!");
